...
#     if ENABLE_HABITS:
#         try:
#             from features.habits.handlers import HandlerHabitsMenu, HandlerAddHabit, HandlerChangeHabit, HandlerShowHabit, HandlerDeleteHabit
#             handler_habits_menu = HandlerHabitsMenu()
#             handler_add_habits = HandlerAddHabit()
#             handler_chenge_habits = HandlerChangeHabit()
#             handler_show_habits = HandlerShowHabit()
#             handler_delete_habits = HandlerDeleteHabit()

#             dp.include_router(handler_habits_menu.router)
#             dp.include_router(handler_add_habits.router)
#             dp.include_router(handler_chenge_habits.router)
#             dp.include_router(handler_show_habits.router)
#             dp.include_router(handler_delete_habits.router)
#         except Exception as e:
